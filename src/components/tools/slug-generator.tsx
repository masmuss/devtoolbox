        ...
        <div className="mb-8 grid gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                            <Checkbox
                                ...
                                onCheckedChange={(checked) => setField("lowercase", !!checked)}
                            />
                        ...
                        <div className="flex items-center space-x-2">
                            <Checkbox
                                ...
                                onCheckedChange={(checked) => setField("removeSpecialChars", !!checked)}
                            />
            ...
            <Card className="border-gray-200 dark:border-gray-800">
                ...
                <CardContent className="space-y-4">
                    <div className="relative">
                        ...
                        {state.output && (
                            <Button
                                ...
                                className="absolute top-1/2 right-2 h-8 w-8 -translate-y-1/2 p-0 hover:bg-gray-100 dark:hover:bg-gray-800"
                            >
                    ...
                    {state.copied && (
                        <p className="text-sm text-green-600 dark:text-green-400">Slug copied to clipboard!</p>
                    )}
