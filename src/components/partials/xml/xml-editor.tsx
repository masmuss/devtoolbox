	...
	return (
		<div className="space-y-6">
			<ToolSection
				icon={FileText}
				title="XML Input"
				description="Paste your XML data to format or validate"
			>
			...
			{formatted && (
				<ToolSection title="Formatted XML" description="Pretty-printed XML with proper indentation">
			...
			{minified && (
				<ToolSection title="Minified XML" description="Compressed XML with minimal whitespace">
					<div className="space-y-3">
						<div className="relative">
							<Textarea
								value={minified}
